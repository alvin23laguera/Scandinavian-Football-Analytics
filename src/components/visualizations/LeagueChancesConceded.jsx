...
const LeagueChancesConceded = ({ chanceStats, getBadge, selectedTeam = null }) => {
    ...
    if (!chanceStats || sortedTeams.length === 0) {
        return <div style={{ color: 'var(--color-text-secondary)', fontSize: '0.9rem' }}>No chances conceded data available.</div>;
    }
...
export default LeagueChancesConceded;
